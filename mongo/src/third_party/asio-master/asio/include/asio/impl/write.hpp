...
namespace detail
{
  ...
  public:
    ...
    {
      std::size_t max_size;
	  //int ret3 = system("echo operator-writ2e1111-ddd-test-start-mongodb >> /asio.txt");
		//		  ret3 = 0;
      switch (start_ = start)
      {
        case 1:
        ...
        do
        {
          ...
          return; default:
			...
			//int ret = system("echo operator-write-ddd-test2222-start-mongodb >> /asio.txt");
		  //ret = 0;
		...
		//int ret2 = system("echo operator-writ2e3333-ddd-test-start-mongodb >> /asio.txt");
			//	  ret2 = 0;
