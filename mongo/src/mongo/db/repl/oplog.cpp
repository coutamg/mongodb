...
db.sbtest1.remove({"k" : 16322011}) 对应oplog如下: 注意o就是要删除的内容，查询条件{"k" : 16322011}被转换为了唯一索引{ "_id" : 234503495 }
 ...
 */ 
 //写操作写oplog流程OpObserverImpl::onInserts->logInsertOps->_logOpsInner->CollectionImpl::insertDocumentsForOplog
...
//参考http://www.mongoing.com/archives/3177
