...
Status WiredTigerRecordStore::_insertRecords(OperationContext* opCtx,
    ...
    for (size_t i = 0; i < nRecords; i++) {
		...
		*/
		...
		//2021-03-24T10:58:46.762+0800 I STORAGE  [conn-1] ddd test ...WiredTigerRecordStore::_insertRecords . _uri:table:test/collection/7-380857198902467499 key:RecordId(15) value:{ _id: ObjectId('605aaae6cd83d63c5a6bb264'), name1: 2223.0 }
		log() << "ddd test ...WiredTigerRecordStore::_insertRecords . _uri:" << _uri <<" key:" << record.id << " value:" << redact(record.data.toBson());
