...
2019-03-27T11:03:58.065+0800 D SHARDING [conn----yangtest2] ddd test   run command admin.$cmd { isMaster: 1, client: { application: { name: "MongoDB Shell" }, driver: { name: "MongoDB Internal Client", version: "3.6.6" }, os: { type: "Linux", name: "CentOS Linux release 7.2.1511 (Core) ", architecture: "x86_64", version: "Kernel 3.10.0-327.el7.x86_64" } }, $db: "admin" } isMaster
...
2019-03-27T11:03:58.066+0800 D SHARDING [conn----yangtest2] ddd test   run command admin.$cmd { whatsmyuri: 1, $db: "admin" } whatsmyuri
...
2019-03-27T11:03:58.066+0800 D SHARDING [conn----yangtest2] ddd test   run command admin.$cmd { buildinfo: 1.0, $db: "admin" } buildinfo
...
2019-03-27T11:03:58.067+0800 D SHARDING [conn----yangtest2] ddd test   run command admin.$cmd { isMaster: 1.0, $clusterTime: { clusterTime: Timestamp(1553655835, 1), signature: { hash: BinData(0, B7A37AAB82E8E496CBDB5F525844062F4DDD8EDD), keyId: 6660292243598868500 } }, $db: "admin" } isMaster
...
2019-03-27T11:03:58.068+0800 D SHARDING [conn----yangtest2] ddd test   run command admin.$cmd { saslStart: 1, mechanism: "SCRAM-SHA-1", payload: "xxx", $db: "admin" } saslStart
...
2019-03-27T11:03:58.078+0800 D SHARDING [conn----yangtest2] ddd test   run command admin.$cmd { saslContinue: 1, payload: BinData(0, 633D626977732C723D76514341592B6C69356A7871564A79564277656648576B5958315557583579442F4B6B6A2B585431337265692F644E37304A6C626B4B7439546C516656...), conversationId: 1, $db: "admin" } saslContinue
...
2019-03-27T11:03:58.078+0800 D SHARDING [conn----yangtest2] ddd test   run command admin.$cmd { saslContinue: 1, payload: BinData(0, ), conversationId: 1, $db: "admin" } saslContinue
...
2019-03-27T11:03:58.081+0800 D SHARDING [conn----yangtest2] ddd test   run command admin.$cmd { getLog: "startupWarnings", $clusterTime: { clusterTime: Timestamp(1553655835, 1), signature: { hash: BinData(0, B7A37AAB82E8E496CBDB5F525844062F4DDD8EDD), keyId: 6660292243598868500 } }, $db: "admin" } getLog
...
2019-03-27T11:03:58.081+0800 D SHARDING [conn----yangtest2] ddd test   run command test.$cmd { isMaster: 1.0, forShell: 1.0, $clusterTime: { clusterTime: Timestamp(1553655837, 1), signature: { hash: BinData(0, D07A1335C015A7A1604ADCC08D5860FCDA9A22AC), keyId: 6660292243598868500 } }, $db: "test" } isMaster
...
2019-03-27T11:03:58.082+0800 D SHARDING [conn----yangtest2] ddd test   run command test.$cmd { buildInfo: 1.0, $clusterTime: { clusterTime: Timestamp(1553655837, 1), signature: { hash: BinData(0, D07A1335C015A7A1604ADCC08D5860FCDA9A22AC), keyId: 6660292243598868500 } }, $db: "test" } buildInfo
...
2019-03-27T11:03:58.083+0800 D SHARDING [conn----yangtest2] ddd test   run command test.$cmd { isMaster: 1.0, forShell: 1.0, $clusterTime: { clusterTime: Timestamp(1553655837, 1), signature: { hash: BinData(0, D07A1335C015A7A1604ADCC08D5860FCDA9A22AC), keyId: 6660292243598868500 } }, $db: "test" } isMaster
...
2019-03-27T11:03:58.083+0800 D SHARDING [conn----yangtest2] ddd test   run command admin.$cmd { replSetGetStatus: 1.0, forShell: 1.0, $clusterTime: { clusterTime: Timestamp(1553655837, 1), signature: { hash: BinData(0, D07A1335C015A7A1604ADCC08D5860FCDA9A22AC), keyId: 6660292243598868500 } }, $db: "admin" } replSetGetStatus
